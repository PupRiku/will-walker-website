...
export const worksData: Work[] = [
  ...
  {
    slug: 'the-camp-cacophony-hour-sasquatch-stole-the-side-dish',
  ...
  {
    slug: 'the-to-do-list-1-coffee-2-dont-get-eaten-by-a-dinosaur-a-one-act-office-comedy-of-jurassic-proportions',
    title:
  ...
  {
    slug: 'shakespeare-shorts-a-collection-of-short-and-not-so-short-plays-based-and-or-inspired-by-william-shakespeare',
    title:
  ...
  {
    slug: 'so-what-had-happened-was-or-who-killed-the-director-a-ridiculous-10-minute-play-that-should-probably-be-arrested-for-overacting',
    title:
  ...
  {
    slug: 'the-other-side-of-quiet-a-play-about-borders-becoming-and-belonging',
    title:
  ...
  {
    slug: 'the-sacred-art-of-falling-the-fight-she-inherited-the-future-she-claimed',
    title:
  ...
  },
  {
    ...
    pdfSrc:
      'https://www.nextstagepress.com/wp-content/uploads/2026/04/R.U.R.-Rossums-Universal-Robots-Sample.pdf',
    cast: '8M/6F/4 Flexible',
    runtime: '120 minutes',
    synopsis:
      "In a future ruled by Rossum Industries, humanity has created Robots to serve, laboring without emotion or desire. Helena Glory, the President's daughter, is disturbed by the ethics of treating sentient beings as tools. As the Robots gain autonomy, they reflect humanity's flaws, raising urgent questions about freedom, morality, and the cost of progress. Domin, the CEO, celebrates the rise of efficiency, while Helena and Nana confront the consequences of unchecked innovation. When human life teeters on the brink, Alquist, a broken engineer, must reckon with the legacy of Rossum's creations. Helena, driven by conscience, fights for the Robots' right to freedom in a collapsing world. As the Robots rise, humanity faces extinction, and a new order emerges—one shaped by the very beings once made to serve it.",
    featured: true,
    published: true,
  ...
  },
  {
    ...
    runtime: '45 minutes',
    synopsis:
      "He's back—and this time, he brought even more red string. In The Mothman of Monticello, the second installment of The Doug Plays: Doug's Guide to the Unexplained (and Totally True!), our laser-pointer-wielding conspiracy theorist returns with a bigger theory, a larger wall of questionable evidence, and a dangerous surplus of Girl Scout cookies to prove the unthinkable: Mothman didn't just predict disasters—he helped build America. From Jefferson's Monticello to modern surveillance, Doug and his increasingly concerned companions spiral through history, technology, and snack-based mind control in a frantic quest to expose the nation's true architect. Packed with wilder theories, blurrier proof, and absolutely no regard for the line between fact and fiction, this installment cranks the chaos even higher—and hints that Doug's not done yet… because somewhere out there, even more dots are waiting to be connected.",
    featured: false,
    published: false,
  },
];
